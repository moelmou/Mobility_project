...
<html lang="en">
  ...
  <body>
    <div class="container d-flex d-flex align-items-center justify-content-center">
     
        <form action="pub_resultat_ge.php" method="post" enctype="multipart/form-data" >
        <h2>Publier Resultats de génie electrique :</h2>
          <div class="form-group">
            <input type="text" class="form-control" name="title" placeholder="Titre : Date(AAAA-MM-JJ)">
          </div>
          <div class="form-group">
