...
if(!empty($_POST)){
     $ID= $_POST['ID']; 
     $sql = "DELETE FROM etudiant_list_concernes  WHERE ID = $ID";
...
<head>
    <meta charset="utf-8">
      ...
      <title> Supprimer etudiant concernee confirmation</title>
    ...
    <div class="row">            
      <form class="form-horizontal" action="delete.php" method="post">
        <input type="hidden" name="ID" value="<?php echo $ID;?>"/>                 
         Est ce que vous etes sure de supprimer cet etudiant ?
        <div class="form-actions">
          <button type="submit" class="btn btn-danger">Oui</button>
          <a class="btn" href="MassUpload.php">Non</a>
        </div>
      </form>
    </div>   
  </div>              
